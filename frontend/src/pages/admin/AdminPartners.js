...
import { Handshake, Search, UserCircle, Shield, Scissors } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage business partners</p>
      </div>

      <div className="p-3 rounded-lg border border-border/40 bg-card/30 text-sm font-medium text-muted-foreground inline-block">
        Total Partners: <span className="text-primary">{users.length}</span>
      </div>
